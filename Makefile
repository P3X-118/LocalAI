...
LD_FLAGS?=-s -w
override LD_FLAGS += -X "github.com/P3X-118/LocalAI/internal.Version=$(VERSION)"
override LD_FLAGS += -X "github.com/P3X-118/LocalAI/internal.Commit=$(shell git rev-parse HEAD)"
