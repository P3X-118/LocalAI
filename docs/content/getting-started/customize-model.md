...
You can also check all the embedded models configurations [here](https://github.com/P3X-118/LocalAI/tree/master/embedded/models).

{{% notice tip %}}
The model configurations used in the quickstart are accessible here: [https://github.com/P3X-118/LocalAI/tree/master/embedded/models](https://github.com/P3X-118/LocalAI/tree/master/embedded/models). Contributions are welcome; please feel free to submit a Pull Request.

The `phi-2` model configuration from the quickstart is expanded from [https://github.com/P3X-118/LocalAI/blob/master/examples/configurations/phi-2.yaml](https://github.com/P3X-118/LocalAI/blob/master/examples/configurations/phi-2.yaml).
 {{% /notice %}}

## Example: Customizing the Prompt Template

To modify the prompt template, create a Github gist or a Pastebin file, and copy the content from [https://github.com/P3X-118/LocalAI/blob/master/examples/configurations/phi-2.yaml](https://github.com/P3X-118/LocalAI/blob/master/examples/configurations/phi-2.yaml). Alter the fields as needed:
