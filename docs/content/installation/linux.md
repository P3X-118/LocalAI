...
You can manually download the appropriate binary for your system from the [releases page](https://github.com/P3X-118/LocalAI/releases):

1. Go to  [GitHub Releases](https://github.com/P3X-118/LocalAI/releases)
